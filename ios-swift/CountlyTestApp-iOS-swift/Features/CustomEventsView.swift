    ...
    var body: some View {
        Form {
            ...
            Section {
                ...
                Text("Over-long keys and values are truncated to the configured limits. An empty key is dropped, and an unsupported value type is removed from the segmentation.")
            }
        }
    }
}
