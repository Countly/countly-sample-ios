    ...
    var body: some View {
        FeatureList {
            Section {
                ...
                FootnoteText("The SDK never asks the device for a location. Everything here is supplied by the host application.")
            }
            ...
            Section {
                ...
                FootnoteText("Sends an empty location, which clears what the server holds and stops it deriving one from the IP address.")
            }
        }
    }
}
