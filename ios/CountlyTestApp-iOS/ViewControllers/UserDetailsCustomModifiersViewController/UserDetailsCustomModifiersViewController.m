        ...
        UIAlertAction* ok = [UIAlertAction actionWithTitle:@"OK" style:UIAlertActionStyleDefault handler:^(UIAlertAction * action)
        {
            ...
            if(key.length && (value.length || isOnlyKey))
            {
                switch (indexPath.row)
                {
                    ...
                    case 4: [Countly.user incrementBy:key value:[value integerValue]]; break;
                    case 5: [Countly.user multiply:key value:[value integerValue]]; break;
                    case 6: [Countly.user max:key value:[value integerValue]]; break;
                    case 7: [Countly.user min:key value:[value integerValue]]; break;
